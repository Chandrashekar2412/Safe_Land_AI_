...
const SafeLandAI = () => {
  return (
    <PageTemplate
      title="Safe Land Assist"
      subtitle="Learn more about our innovative hard landing prediction system"
    >
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-4">About Safe Land Assist</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          Safe Land Assist can predict potential hard landing scenarios with high accuracy.
        </p>
